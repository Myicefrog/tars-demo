...
g++ -Wall -g -std=c++11 -o tar-client tar_client.cpp CommunicatorEpoll.cpp tc_thread.cpp tc_thread_mutex.cpp tc_epoller.cpp AsyncProcThread.cpp tc_socket.cpp tc_thread_cond.cpp tc_ex.cpp NetworkUtil.cpp ObjectProxy.cpp Transceiver.cpp tc_buffer.cpp -lpthread
